...
% -------------------------------------------------------------------------------------------------
\titulo{Extensionly - A tool for supporting the management of outreach projects and programs in the university: Frontend}
...
\input{pretextuais/resumo} % Resumo [OBRIGATÓRIO]
\input{pretextuais/abstract} % Abstract (resumo em inglês) [OBRIGATÓRIO]
...
\input{textuais/1-introducao} % [OBRIGATORIO]
\input{textuais/2-metodologia} % [OBRIGATORIO]
\input{textuais/3-background}
\input{textuais/4-literaturacinza}
\input{textuais/5-survey}
\input{textuais/6-extensionly}
\input{textuais/7-conclusao} % [OBRIGATORIO]


% ELEMENTOS PÓS-TEXTUAIS
\postextual

\bibliography{bibliografia} % Bibliografia [OBRIGATORIO]
\input{postextuais/apendices} % Apêndices [OPCIONAL]
